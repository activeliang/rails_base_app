...
`scp docker-compose-production.yml root@178.128.214.6:/home/deploy/myapp.yml`

p 'pull Image from Docker Hub'
`ssh root@178.128.214.6  'docker pull activeliang/myapp'`

p 'remote docker-compose up'
`ssh root@178.128.214.6  'cd /home/deploy && RAILS_ENV=production docker-compose up -f /home/deploy/myapp.yml'`